...
-(NSInteger) runModalSheetForWindow:(NSWindow *)aWindow {
    bool exitEnabled = [[aWindow standardWindowButton:NSWindowCloseButton] isEnabled];
    bool miniEnabled = [[aWindow standardWindowButton:NSWindowMiniaturizeButton] isEnabled];
    bool zoomEnabled = [[aWindow standardWindowButton:NSWindowZoomButton] isEnabled];
    ...
    [[aWindow standardWindowButton:NSWindowCloseButton] setEnabled:exitEnabled];
    [[aWindow standardWindowButton:NSWindowMiniaturizeButton] setEnabled:miniEnabled];
    [[aWindow standardWindowButton:NSWindowZoomButton] setEnabled:zoomEnabled];
